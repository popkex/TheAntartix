translations = {
    ...
    "message_system": {
        ...
        'defense': 'You managed to raise your shield in time!',
        'fail_defense': "Unfortunately, you failed to block the attack",
        'player_attack': "You attacked!",
        'player_crit': "You dealt a critical hit!",
        'player_fail_attack': 'You missed your attack',
        'enemy_fail_attack': "Your enemy failed to hit you!",
    ...
    "enemyA": {
        'name': "enemy A",
        'lanch_fight_message': "Enemy A encountered you",
    },
    ...
    'npc': {
        ...
        'paul': ["Hello, I'm Paul", "How are you?", "Who are you?", "I'm afraid of monsters", "I'd love for someone to help me get rid of \nthese monsters.", "About twenty? \nThank you, I'll reward you well"],
        "paul_after_quest": ["test, test"],
        'michel': ["I'm badly injured from my \nexcursion in this dungeon.", "Too bad I didn't have a healing potion \notherwise I wouldn't be in this state", "You better get some, trust me"],
    ...
    'michel_quest': {
        'title': "Get healing potions to avoid getting hurt",
        'description': "Get 10 healing potions to avoid getting hurt in combat like poor Michel"
    },

    'paul_quest': {
        'title': "Kill monsters so Paul won't be scared",
    ...
    "victory": {
        ...
        "victory1": "Outstanding victory! You dominated the game with style.",
        ...
        "victory5": "Legendary triumph! You enter the history books.",
        ...
        "victory9": "Remarkable feat! You won with flair.",

        "enemy_death": "You defeated:",
        "object_won": "You won",
        "not_object_won": "You didn't manage to get an item",
        "xp_won": "You gained",
    ...
    "tutorials": {
        "tutorial": "Tutorial",
        "tuto_iv": ["Here is your inventory.", "Here (as in any inventory), \nyou will be able to store items and use them.", "You can press 'E' to open and close it anytime."],
        "tuto_fight": ["Here you are in combat!", "Here, by pressing 'A', you can attack your \nopponent. In return, you will take damage.", "If you die, your life will return to 50% of your max\nlife, you will lose experience/level down!", "And you will restart at the beginning of the \nlevel! Although all interactions with \nthe map will remain", "But if you manage to kill your opponent, \nyou will gain experience and items.", "You can also defend yourself with 'Z', reducing the \ndamage taken by a % that can vary over time", "open your inventory by pressing 'E' \nand escape with 'ESC'.", "I'll tell you a secret, you can also click \non the icons with your mouse to perform the action", "But beware, if you flee, you might not \nsucceed and you will take damage.", "Good luck and don't get killed!"],
    },
    ...
    'game_over': {
        'fight_message_1': "He wanted to be a hero, but ended up a zero.",
        ...
        'fight_message_4': "He ran towards glory, but stumbled over his own sword.",
        'fight_message_5': "He jumped into battle... and directly into a trap.",
