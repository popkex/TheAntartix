translations = {
    ...
    'npc': {
        ...
        'paul': ['Bonjour je suis paul', 'Comment vas tu ?', 'Qui est tu ?', 'Pourquoi tu ne me parle pas ? Tu veux quoi ?', 'Je fais finir par appeler la police si tu continue', '...', '...', '...']
    },
