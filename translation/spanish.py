translations = {
    ...
    'npc': {
        ...
        'michel': ['Estoy gravemente herido debido a mi\nexcursión en este calabozo.', '¿No querrías traerme 2 pociones de curación?'],
    },
    ...
    'paul_quest': {
        'title': 'Dar pociones de curación a Paul',
        'description':'pruebazar',
    },
    ...
    'game_over': {
        ...
        'fight_message_6': "Gritó '¡Por honor!', pero todo lo que se oyó fue '¡Ay!'",
        'fight_message_7': "Luchó como un león, pero por desgracia, era sólo un gatito.",
