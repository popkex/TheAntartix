translations = {
    "message_system": {
        ...
        "defense": "¡Has logrado levantar tu escudo a tiempo!",
        "fail_defense": "Lamentablemente no has logrado bloquear ese ataque",
        "player_attack": "¡Has atacado!",
        "player_crit": "¡Has hecho un daño crítico!",
        "player_fail_attack": "Has fallado tu ataque",
        "enemy_fail_attack": "¡Tu enemigo no logró apuntarte!",
        "enemy_known_out_player": "¡Has aturdido a tu enemigo!",
    ...
    "objects": {
        ...
        "Big_Life_Potion": "gran poción de vida",
        "Bomb": "bombas",
    },
    ...
    "npc": {
        ...
        "michel": ["Estoy gravemente herido por mi \nexcursión en este calabozo.", "Lástima que no tenía más pociones de vida \nsi no, no estaría en este estado", "Deberías recuperar algunas, créeme"],
        "michel_after_quest": ["prueba"],
        "fleufleu": ["Los días pasan y se parecen, \npero encuentro mi felicidad en las pequeñas cosas.", "Una sonrisa compartida, \nel calor del sol en mi piel, \nla melodía de una canción lejana...", "Esos momentos efímeros son tesoros"]
    },
    ...
    "victory": {
        ...
        "victory1": "¡Victoria brillante! Has dominado el juego con estilo.",
        "victory2": "¡Misión cumplida! Eres el héroe del día.",
        "victory3": "¡Éxito total! Tu estrategia ha dado frutos.",
    ...
    "tutorials": {
        "tutorial": "Tutorial",
        "tuto_iv": ["Aquí está tu inventario.", "Aquí (como en cualquier inventario), \npuedes almacenar objetos y usarlos.", "Puedes presionar 'E' para cerrarlo y abrirlo/cerrarlo cuando quieras."],
        "tuto_fight": ["¡Estás en combate!", "Aquí, presionando 'A', puedes atacar a tu \nadversario. A cambio recibirás daño.", "Si mueres, tu vida volverá al 50% de tu vida máxima, \nperderás experiencia/bajarás de nivel!", "Y sobre todo, ¡comenzarás desde el principio del \nnivel! Aunque todas las interacciones con \nla mapa permanecerán", "Pero si logras matar a tu adversario, \nganas experiencia y objetos.", "También puedes defenderte con 'Z', reducirás \nlos daños sufridos en un % que puede variar con el tiempo", "abre tu inventario presionando 'E' \ny huye con 'ESC'.", "Te diré un secreto, también puedes presionar \nsobre los íconos con tu ratón para ejecutar la acción", "Pero cuidado, si huyes, puede que no lo \nlogres y recibirás daño.", "Buena suerte y ¡no te mates!"],
    },
    ...
    "settings_menu": {
        ...
        "language": "Idioma",
        "game_settings": "Configuraciones del juego",
        "back": "Volver",
    },
    ...
    "game_over": {
        "fight_message_1": "Quiso ser el héroe, pero terminó siendo un cero.",
        ...
        "fight_message_6": "Gritó '¡Por el honor!', pero todo lo que se escuchó fue '¡Ay!'",
